...
function bot(settings) {
  return new Promise((function (resolve, reject) {
                ...
                ws.on("open", (function (param) {
                        ...
                        var data;
                        try {
                          data = Data$Record.Decode[/* data */12](Json.parseOrRaise(message));
                        }
                        catch (exn){
                          if (exn === Data$Record.NotImplemented) {
                            data = undefined;
                          } else {
                            throw exn;
                          }
                        ...
                        if (data !== undefined) {
                          var data$1 = data;
                          console.log(data$1);
                          var match = data$1[/* d */1];
                          if (typeof match === "number" || match.tag !== 3) {
                            return /* () */0;
                          } else {
                            setInterval((function (param) {
                                    ws.send(Json.stringify(Data$Record.Encode[/* dataFromPayload */10](/* Heartbeat */Block.variant("Heartbeat", 1, [undefined]))));
                                    return /* () */0;
                                  }), match[0][/* heartbeat_interval */0]);
                            ws.send(Json.stringify(Data$Record.Encode[/* dataFromPayload */10](/* Identify */Block.variant("Identify", 2, [/* record */Block.record([
                                                "token",
                                                "properties",
                                                "compress",
                                                "large_threshold",
