...
function bot(settings) {
  return new Promise((function (resolve, reject) {
                ...
                ws.on("open", (function (param) {
                        ...
                        console.log(message);
                        var data = Data$Record.Decode[/* data */1](Json.parseOrRaise(message));
                        console.log(data);
                        var match = data[/* d */1];
                          ...
                          switch (match.tag | 0) {
                            ...
                            case 2 : 
                                setInterval((function (param) {
                                        ws.send(Json.stringify(Data$Record.Encode[/* dataFromPayload */10](/* Heartbeat */Block.variant("Heartbeat", 0, [undefined]))));
                                        return /* () */0;
                                      }), match[0][/* heartbeat_interval */0]);
                                ws.send(Json.stringify(Data$Record.Encode[/* dataFromPayload */10](/* Identify */Block.variant("Identify", 1, [/* record */Block.record([
                                                    "token",
                                                    "properties",
                                                    "compress",
                                                    "large_threshold",
