...
function bot(settings) {
  return new Promise((function (resolve, reject) {
                ...
                ws.on("open", (function (param) {
                        ...
                        console.log(message);
                        var data = Data$Record.Decode[/* data */4](Json.parseOrRaise(message));
                        console.log(data);
                        var match = data[/* d */1];
                        if (typeof match === "number" || match.tag !== 3) {
                          ...
                          setInterval((function (param) {
                                  ws.send(Json.stringify(Data$Record.Encode[/* dataFromPayload */11](/* Heartbeat */Block.variant("Heartbeat", 1, [null]))));
                                  return /* () */0;
                                }), match[0][/* heartbeat_interval */0]);
                          ws.send(Json.stringify(Data$Record.Encode[/* dataFromPayload */11](/* Identify */Block.variant("Identify", 2, [/* record */Block.record([
                                              "token",
                                              "properties",
                                              "compress",
                                              "large_threshold",
