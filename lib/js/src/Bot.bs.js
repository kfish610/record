                          ...
                          switch (match.tag | 0) {
                            ...
                            case 2 : 
                                setInterval((function (param) {
                                        ws.send(Json.stringify(Data$Record.Encode[/* dataFromPayload */9](/* Heartbeat */Block.variant("Heartbeat", 0, [undefined]))));
                                        return /* () */0;
                                      }), match[0][/* heartbeat_interval */0]);
                                ws.send(Json.stringify(Data$Record.Encode[/* dataFromPayload */9](/* Identify */Block.variant("Identify", 1, [/* record */Block.record([
                                                    "token",
                                                    "properties",
                                                    "compress",
                                                    "large_threshold",
